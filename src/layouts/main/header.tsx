        ...
        <div className="max-w-6xl mx-auto px-5 xl:px-0">
          <div className="h-20 flex justify-between items-center w-full">
            ...
            <Link href={paths.website.signin}>
              <div className="sm:flex items-center gap-3 mr-7 cursor-pointer hidden">
                <div className="h-6 w-6">
                  <FaRegUserCircle className="text-orange-600 font-extrabold text-2xl" />
                </div>
                <div className="flex items-start flex-col">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <div
                  className={`w-4 h-4 right-0 flex items-center justify-center absolute top-1 rounded-full text-[10px] leading-none text-white font-medium bg-primary`}
                >
