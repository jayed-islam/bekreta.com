...
const CartHeaderPopup = () => {
  ...
  return (
    <div className="">
      {/* {cartItems?.length === 0 ? (
        <div className={`absolute -right-28 sm:right-0 block border-t'}`}>
          <div
            className={` z-10 w-screen max-w-xs  sm:max-w-md px-4 mt-3.5 sm:px-0 opacity-100 translate-y-0 `}
          >
              ...
              <div className="relative bg-white">
                <div className="max-h-[60vh] p-5 overflow-y-auto hiddenScrollbar">
                  <h3 className="text-md font-medium">
                    ...
                    <Link
                      to="/products"
                      className="text-yellow-400 hover:text-yellow-500 transition-all duration-300 ease-in"
                    >
                      Add Products
                    </Link>
                  </h3>
              ...
              <div className="relative bg-white">
                            ...
                            <div className="flex justify-between ">
                              <div>
                                <h3 className="text-base font-medium ">
                                  <a href="/product-detail">{cart?.name}</a>
                                </h3>
                ...
                <div className="bg-neutral-50 p-5">
                  ...
                  <div className="flex space-x-2 mt-5">
                    ...
                    <Link
                      href="/"
                      className="nc-Button relative h-auto inline-flex items-center justify-center rounded-full transition-colors text-sm sm:text-base font-medium py-3 px-4 sm:py-3.5 sm:px-6 ttnc-ButtonPrimary disabled:bg-opacity-90 bg-slate-900  hover:bg-slate-800 text-slate-50 shadow-xl flex-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0 "
                    >
                      Check out{" "}
                    </Link>
                  </div>
