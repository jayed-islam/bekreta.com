...
const FeaturedSuccessView = () => {
  ...
  return (
    <div className="bg-gray-100 px-5 xl:px-0 py-16">
      <div className="max-w-6xl mx-auto py-16 md:py-24 bg-white border shadow">
        <div className="flex items-center flex-col justify-center">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6 flex-col md:flex-row items-center justify-center">
              ...
              >
                বিক্রেতা ওয়েবসাইটে অর্ডার স্ট্যাটাস দেখুন
              </Button>
            </div>
          </div>
        </div>
...
export default FeaturedSuccessView;
